...
#if !defined( _AGDB_TEST_GETOPT_H )
#define _AGDB_TEST_GETOPT_H
...
#define agdb_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t agdb_test_getopt(
                  int argument_count,
...
#endif /* !defined( _AGDB_TEST_GETOPT_H ) */
