/*
 * The database header definition of a Windows SuperFetch database file
 *
...
#if !defined( _AGDB_DATABASE_HEADER_H )
#define _AGDB_DATABASE_HEADER_H
...
#endif /* !defined( _AGDB_DATABASE_HEADER_H ) */
