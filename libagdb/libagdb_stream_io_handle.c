...
{
	static char *function = "libagdb_stream_io_handle_initialize";
	...
	*io_handle = memory_allocate_structure(
	...
	if( memory_set(
	     *io_handle,
	     0,
	     sizeof( libagdb_stream_io_handle_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int libagdb_stream_io_handle_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_free";
...
int libagdb_stream_io_handle_clone(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_clone";
...
int libagdb_stream_io_handle_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_open";
...
int libagdb_stream_io_handle_close(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_close";
...
ssize_t libagdb_stream_io_handle_read(
         ...
         libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_read";
...
ssize_t libagdb_stream_io_handle_write(
         ...
         libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_write";
...
off64_t libagdb_stream_io_handle_seek_offset(
         ...
         libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_seek_offset";
	...
	offset = libagdb_stream_seek_offset(
	          io_handle->stream,
	          offset,
	          whence,
	          error );
...
int libagdb_stream_io_handle_exists(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_exists";
...
int libagdb_stream_io_handle_is_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_is_open";
...
int libagdb_stream_io_handle_get_size(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_stream_io_handle_get_size";
