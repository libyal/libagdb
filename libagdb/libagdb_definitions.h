 ...
 */
#else
#define LIBAGDB_VERSION					20140423

/* The version string
 */
#define LIBAGDB_VERSION_STRING				"20140423"
 ...
 */
enum LIBFWNT_FILE_TYPES
{
	LIBFWNT_FILE_TYPE_UNCOMPRESSED			= 1,
	LIBFWNT_FILE_TYPE_COMPRESSED_VISTA		= 2,
	LIBFWNT_FILE_TYPE_COMPRESSED_WINDOWS7		= 3,
	LIBFWNT_FILE_TYPE_COMPRESSED_WINDOWS8		= 4
};
