...
{
	static char *function = "libagdb_stream_descriptor_initialize";
	...
	*stream_descriptor = memory_allocate_structure(
	...
	if( memory_set(
	     *stream_descriptor,
	     0,
	     sizeof( libagdb_stream_descriptor_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int libagdb_stream_descriptor_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_stream_descriptor_free";
	int result            = 1;
...
int libagdb_stream_descriptor_set_data_range(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_stream_descriptor_set_data_range";
