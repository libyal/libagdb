...
{
	static char *function = "libagdb_notify_set_stream";
...
int libagdb_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libagdb_notify_stream_open";
...
int libagdb_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libagdb_notify_stream_close";
