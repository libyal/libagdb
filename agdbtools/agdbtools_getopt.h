...
#if !defined( _AGDBTOOLS_GETOPT_H )
#define _AGDBTOOLS_GETOPT_H
...
typedef struct agdbtools_option agdbtools_option_t;

struct agdbtools_option
{
...
#define agdbtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t agdbtools_getopt(
                  int argument_count,
...
void agdbtools_getopt_wrapped_fprint(
      FILE *stream,
...
void agdbtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const agdbtools_option_t *options,
      int number_of_options );

int agdbtools_getopt_get_options_string(
     const agdbtools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _AGDBTOOLS_GETOPT_H ) */
